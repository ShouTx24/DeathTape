...
UNREALROOTPATH = /mnt/vm-storage/UnrealEngine
GAMEPROJECTFILE =/home/burnert/dev/DeathTape/DeathTape.uproject

TARGETS = \
	DeathTape-Linux-Debug  \
	DeathTape-Linux-DebugGame  \
	DeathTape-Linux-Test  \
	DeathTape-Linux-Shipping  \
	DeathTape \
	DeathTapeEditor-Linux-Debug  \
	DeathTapeEditor-Linux-DebugGame  \
	DeathTapeEditor-Linux-Test  \
	DeathTapeEditor-Linux-Shipping  \
	DeathTapeEditor \
...
StandardSet: RequiredTools UnrealFrontend DeathTapeEditor UnrealInsights

DebugSet: RequiredTools UnrealFrontend-Linux-Debug DeathTapeEditor-Linux-Debug


DeathTape-Linux-Debug:
	 $(PROJECTBUILD) DeathTape Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

DeathTape-Linux-DebugGame:
	 $(PROJECTBUILD) DeathTape Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

DeathTape-Linux-Test:
	 $(PROJECTBUILD) DeathTape Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

DeathTape-Linux-Shipping:
	 $(PROJECTBUILD) DeathTape Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

DeathTape:
	 $(PROJECTBUILD) DeathTape Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

DeathTapeEditor-Linux-Debug:
	 $(PROJECTBUILD) DeathTapeEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

DeathTapeEditor-Linux-DebugGame:
	 $(PROJECTBUILD) DeathTapeEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

DeathTapeEditor-Linux-Test:
	 $(PROJECTBUILD) DeathTapeEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

DeathTapeEditor-Linux-Shipping:
	 $(PROJECTBUILD) DeathTapeEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

DeathTapeEditor:
	 $(PROJECTBUILD) DeathTapeEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
